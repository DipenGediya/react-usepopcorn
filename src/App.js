...
import {
  ...
  Movie,
  MoviesList,
} from "./components/mainComponent/MoviesListBox";
import {
  WatchedMoviesList,
  WatchedSummary,
} from "./components/mainComponent/WatchedMoviesBox";
    ...
    <>
      ...
      <Main>
        <Box>
          ...
          {!isLoading && !error && (
            <MoviesList movies={movies} onMovieId={handleMovieId} />
          )}
        </Box>
        <Box>
          {selectedId ? (
